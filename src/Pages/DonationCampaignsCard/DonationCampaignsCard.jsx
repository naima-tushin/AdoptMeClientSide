...
const DonationCampaignsCard = ({ campaign }) => {
  return (
    <div className="rounded shadow-lg">
      <img className="w-full h-[130px]" src={campaign.petImage} alt={campaign.petName} />
      <div className="px-6 py-4">
        ...
        <p className="text-gray-700 text-base mb-2">Donated: ${campaign.donatedAmount ?? '0'}</p>
        <p className="text-gray-700 text-base mb-2 ">Status: {campaign.isPause == true ? 'Donation Paused':'Ongoing'}</p>
